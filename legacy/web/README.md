# Garagem Digital — versão web legada 🚘

> Versão anterior preservada para consulta. O desenvolvimento ativo está em [`mobile/`](../../mobile/) e [`backend/`](../../backend/). Execute os comandos abaixo a partir de `legacy/web/`; os dados MySQL desta versão são independentes do PostgreSQL da versão mobile. [Veja o estado original antes da migração.](https://github.com/raullferreiraa/garagem-digital/tree/legacy/web-v1)
